...
miActividad.imagenes = {
    ...
    monedas: {
        url:"../lupe_commons/img/monedas_09.png",
        nombre: "Monedas",
...
miActividad.dataPanelModal = {
    title:"¡BUEN TRABAJO!",
    imageUrl: miActividad.imagenes.monedas.url,
    mainText:"Encontramos 180 monedas de oro.",
    startsHidden: true,
}
...
miActividad.interface.agregarBloqueListaB(
    {
        nombreCompleto:"Mover Derecha",
        rutaImagen: "../../img/bloques/derecha_blanco.png",
        clave: "derecha",
    }
);
miActividad.interface.agregarBloqueListaB(
...
// Excepcional
miActividad.interface.deshabilitarEdicion()